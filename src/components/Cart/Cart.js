...
const Cart = (props) => {
    ...
    const confirmCartHandler = (userData)=>{
        setIsSubmitting(true);
        fetch("https://http-rqst-app-default-rtdb.firebaseio.com/orders.json",{
            method: "POST",
            body: JSON.stringify({
                user: userData,
    ...
    const cartModalContent = (<React.Fragment>
        {cartItems}
            ...
            {isCheckout && <Checkout onConfirm={confirmCartHandler} onCancel={props.onHideCart}/>}
